...
04_router.py → router RAG basado en LLM
05_generator.py → generador LLM + self-feedback
06_pipeline.py → ejecución completa del RAG con el router 
07_evaluate.py → métricas: token F1, BERTScore, Recall@k, MRR, oracle. comparación: never / always / router RAG