#!/bin/bash
#SBATCH --job-name=apps2-oracle-setfit-500-rag
...
#SBATCH --mem=64GB
#SBATCH --gres=gpu:1
#SBATCH --output=/home/igutierrez134/apps2/logs/batch_oracle_setfit_500_%j.log
#SBATCH --error=/home/igutierrez134/apps2/logs/batch_oracle_setfit_500_%j.err
