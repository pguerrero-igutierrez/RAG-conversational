#!/bin/bash
#SBATCH --job-name=apps2-oracle-setfit
...
#SBATCH --mem=32GB
#SBATCH --gres=gpu:1
#SBATCH --output=/home/igutierrez134/apps2/logs/train_oracle_setfit_%j.log
#SBATCH --error=/home/igutierrez134/apps2/logs/train_oracle_setfit_%j.err
